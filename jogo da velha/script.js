...
function checkCondition() {
  ...
  if (
    ...
    b2.childNodes.length &&
    b3.childNodes.length
  ) {
  ...
  if (
    ...
    b5.childNodes.length &&
    b6.childNodes.length
  ) {
  ...
  if (
    b1.childNodes.length > 0 &&
    b4.childNodes.length &&
    b7.childNodes.length
  ) {
    let b1Child = b1.childNodes[0].className;
    let b4Child = b4.childNodes[0].className;
    let b7Child = b7.childNodes[0].className;
...
// Limpa o jogo, declare o vencedor e atualiza o placar
